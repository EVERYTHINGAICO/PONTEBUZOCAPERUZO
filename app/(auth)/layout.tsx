  ...
  return (
    <>
      <main className="relative flex grow">
        ...
        <>
          {/* Right side */}
          <div className="relative my-6 mr-6 hidden w-auto shrink-0 overflow-visible rounded-2xl z-10 lg:block">
            {/* Background */}
            <div
              ...
              <div className="aspect-video w-full rounded-2xl bg-gray-900 px-5 py-3 shadow-xl transition duration-300">
                ...
                <div className="font-mono text-sm text-gray-500 transition duration-300 [&_span]:opacity-0">
                  ...
                  <span className="animate-[code-3_10s_infinite] text-gray-200">
                    import {"{"} TokenPlugin, NFTPlugin {"}"} from "@solana-agent-kit/plugins";
                  </span>
                  <br />
                  ...
                  <span className="animate-[code-5_10s_infinite] text-gray-200">
                    agent.use(TokenPlugin).use(NFTPlugin);
                  </span>
                </div>
              </div>
            </div>
